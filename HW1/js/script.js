...
fetch('http://localhost/HW1/php/caricamento_treni.php').then(onTreniResponse).then(onTreniJson);
...
function onTreniJson(json) {
	...
	for (treno in json) {
		...
		img2.src = 'http://localhost/HW1/foto/foto2/stella_grigia.jpg';
...
fetch('http://localhost/HW1/php/caricamento_treni.php').then(onStarResponse).then(onStarJson);
...
function onStarJson(json) {
	...
	function selectstar(event) {
		...
		for (ps of pss) {
			for (treno in json) {
				...
				if (ps.textContent === json[treno].nome) {
					...
					const img2 = document.createElement('img');
					img2.src = 'http://localhost/HW1/foto/foto2/stella_gialla.jpg';
					div2.appendChild(img2);
					img2.classList.add('star');
		...
		event.currentTarget.src = 'http://localhost/HW1/foto/foto2/stella_gialla.jpg';
	...
	function deselectstar(event) {
		...
		event.currentTarget.src = 'http://localhost/HW1/foto/foto2/stella_grigia.jpg';
